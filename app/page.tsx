      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-blue-600 tracking-tight">KosFinder</span>
          </div>
          
          {/* Desktop Menu */}
          <div className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Home</a>
            <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Kost</a>
            <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Tentang</a>
            <div className="flex items-center space-x-4 ml-4">
              <button className="text-gray-700 font-medium px-4 py-2">Login</button>
              <button className="bg-blue-600 text-white px-5 py-2 rounded-full font-medium hover:bg-blue-700 transition-all shadow-md shadow-blue-200">
                Register
              </button>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-gray-100 px-4 pt-2 pb-6 space-y-4">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <button className="bg-blue-600 text-white py-2 rounded-lg font-medium">Register</button>
          </div>
        </div>
      )}
    </nav>
  ...
  <div className="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300">
    ...
    <div className="p-5">
      ...
      <div className="flex justify-between items-center">
        <div>
          <span className="text-blue-600 font-bold text-lg">Rp {data.price}</span>
          <span className="text-gray-400 text-xs ml-1">/ bulan</span>
        </div>
        <button className="bg-gray-50 group-hover:bg-blue-600 group-hover:text-white text-gray-600 px-4 py-2 rounded-lg text-sm font-semibold transition-colors">
          Detail
        </button>
      </div>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <div className="bg-white p-2 rounded-2xl md:rounded-full shadow-2xl border border-gray-100 flex flex-col md:flex-row items-center gap-2 max-w-2xl mx-auto">
              ...
              <button className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl md:rounded-full font-bold flex items-center justify-center transition-all">
          ...
          <div className="bg-blue-600 rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-blue-200">
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <button className="bg-blue-500 text-white border border-blue-400 px-8 py-4 rounded-xl font-bold hover:bg-blue-400 transition-colors">
                  Daftar Akun
                </button>
              </div>
            </div>
